...
public class ProductosController : ControllerBase
{
    ...
    [AllowAnonymous]
    [HttpGet("catalogo-duenasb", Name = "GetCatalogoDuenasB")]
    [ProducesResponseType(typeof(IReadOnlyList<CatalogoDuenasBCategoria>), (int)HttpStatusCode.OK)]
    public async Task<ActionResult<IReadOnlyList<CatalogoDuenasBCategoria>>> GetCatalogoDuenasB(
        CancellationToken cancellationToken = default)
    {
        return Ok(await _mediator.ListarCatalogoDuenasBAsync(cancellationToken));
    }
